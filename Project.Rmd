...
## 3.1. How accurately can we predict experience_level within the company using a k-nearest neighbors classification model, while excluding the salary attribute from the dataset?
...
## Failed 1. How much should the salary increase be when you get promoted to a higher Experience Level? (according to similar colleagues with the same job area).
...
## Failed 2. What is more worth, to work in the office at your region or remotely in another region?
...
## Failed 3. Can we identify salary disparities based on residence and other demographic factors?
...
## Failed 4. Join cost of living index dataset into problem dataset
