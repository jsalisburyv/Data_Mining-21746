...
## N. Join cost of living index dataset into problem dataset

```{r}
library(countrycode)
cost_of_living_df = read.csv("Cost_of_Living_Index_2022.csv", stringsAsFactors = TRUE)
cost_of_living_df$Country = countrycode(cost_of_living_df$Country, origin = 'country.name', destination = 'iso2c')
df$cost_index = cost_of_living_df[cost_of_living_df$Country == df$employee_residence, ]$Country
```
